...
EXPERIMENT_NAME = "example_addcoarse_noisymemory"
RANDOM_SEED = 0
N_SAMPLES = 500     # WHEN EXTRACTING RESULTS, CHANGE 2000 to 500 IN THE IPYNB FILE
DELETION_L2_THRESHOLD = 99999.0
DELETION_RETREIVAL_N_TIMES = 99999
CLEANUP_RETRIEVAL_N_TIMES = 0
EXIST_TIME_THRESHOLD = 99999
MIN_MEMORY_SIZE = 1
...
"""
    ...
    if first_line.startswith("yes"):
        ...
        raise ValueError(f"Unexpected format from the Coarse Judge. Full reply:\n{full_reply}")
